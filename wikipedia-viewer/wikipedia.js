...
//animations
$("h1,h2").fadeOut(400);
$("#search").animate({bottom: '175px'}, 400);
$("#articles").fadeIn(700);
...
var offset = 0;
var url = `https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=${searchTerm}&prop=info&inprop=url&utf8=&format=json&origin=*&srlimit=30prop=info&pageids=14640471&inprop=url`;
...
function showArticles(data){
	...
	$.each(data.query.search, function(index, term){
     showHTML += '<li class="li-style"> <a href="#"' + term.pageid + '"<h2>' + term.title + '</h2> </a>';
